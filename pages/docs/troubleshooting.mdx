...
Vantage uses Puppeteer to launch a headless Chrome browser to capture metrics. Additional troubleshooting help can be found <a href="https://github.com/puppeteer/puppeteer/blob/main/docs/troubleshooting.md">here</a>.
